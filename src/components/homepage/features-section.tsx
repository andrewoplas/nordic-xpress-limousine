...
export const FeaturesSection = () => {
  ...
  const features = [
    ...
    {
      heading: t("24_hour_service.heading"),
      description: t("24_hour_service.description"),
      imgSrc: "/images/24-hours-express-service.png",
      imgAlt: "photo of woman in customer service",
      imgWidth: 420,
      imgHeight: 379,
      isReversed: false,
    },
    {
      heading: t("chauffeurs.heading"),
      description: t("chauffeurs.description"),
      imgSrc: "/images/qualified-chauffeurs.png",
      imgAlt: "photo of man accepting client",
      imgWidth: 420,
      imgHeight: 379,
      isReversed: true,
    },
